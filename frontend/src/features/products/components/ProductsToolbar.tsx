    ...
    <div className="relative z-10 flex flex-wrap items-center justify-between gap-4 select-none">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          ...
          className="h-[40px] px-5 rounded-[14px] bg-[#C9783A] text-white text-[15px] font-semibold flex items-center gap-2 hover:brightness-105 hover:translate-y-[-1px] transition-all duration-200 shadow-[0_2px_6px_rgba(201,120,58,0.2)] cursor-pointer"
        >
