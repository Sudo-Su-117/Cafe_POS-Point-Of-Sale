...
export const PRODUCTS_BY_CATEGORY: Record<string, Product[]> = {
  "1": [ // Espresso
    ...
    { id: "p4",  name: "Americano",        price: 3.80, unitOfMeasure: "per piece", tax: 5, description: "Espresso diluted with hot water.",                image: "https://images.unsplash.com/photo-1551030173-1d9694761516?w=200&h=200&fit=crop", status: "Active" },
    { id: "p5",  name: "Latte",            price: 4.20, unitOfMeasure: "per piece", tax: 5, description: "Espresso with generous steamed milk.",            image: "https://images.unsplash.com/photo-1541167760496-1628856ab772?w=200&h=200&fit=crop", status: "Active" },
    { id: "p6",  name: "Macchiato",        price: 3.90, unitOfMeasure: "per piece", tax: 5, description: "Espresso marked with a dash of milk foam.",       image: "https://images.unsplash.com/photo-1595786815358-9f204f2d482c?w=200&h=200&fit=crop", status: "Active" },
  ...
  "3": [ // Pastries
    ...
    { id: "p19", name: "Pain au Chocolat", price: 3.50, unitOfMeasure: "per piece", tax: 5, description: "Croissant dough with dark chocolate.",            image: "https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=200&h=200&fit=crop", status: "Active" },
  ...
  "4": [ // Sandwiches
    { id: "p25", name: "Club Sandwich",    price: 7.00, unitOfMeasure: "per piece", tax: 8, description: "Classic triple-decker club sandwich.",            image: "https://images.unsplash.com/photo-1567234669003-75e525322515?w=200&h=200&fit=crop", status: "Active" },
    ...
    { id: "p27", name: "Avocado Toast",    price: 6.00, unitOfMeasure: "per piece", tax: 8, description: "Smashed avo on sourdough.",                       image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop", status: "Active" },
